...
def forward_selection(data):
    ...
    for i in range(1, num_features + 1):
        ...
        if added_feature != None:
            ...
            print(f"On level {i} i added feature {added_feature} to current set(Accuracy: {best:.2%})\n")
...
def leave_one_out(data, subset):
    # correct used to keep track of objects corectly identified
    correct = 0
    size = len(data)
...
def main(file):
    print("Welcome to Motunrayo Lawrence Feature Selection Algorithm!")
